...
function page() {
  return (
    <>
    <div className="flex w-full mt-24 max-w-sm mx-auto overflow-hidden bg-white    lg:max-w-6xl">
    <div className="w-full px-6 py-8 md:px-8 lg:w-1/2">
        ...
        <div className="mt-4">
            ...
            <input id="LoggingEmailAddress" className="block w-full px-4 py-2 text-gray-700 bg-white border rounded-lg dark:text-gray-300 border-gray-600 focus:border-blue-400 focus:ring-opacity-40  focus:outline-none focus:ring focus:ring-blue-300" type="email" />
        </div>
        ...
        <div className="mt-4">
            ...
            <input id="loggingPassword" className="block w-full px-4 py-2 text-gray-700 bg-white border rounded-lg dark:text-gray-300 dark:border-gray-600 focus:border-blue-400 focus:ring-opacity-40  focus:outline-none focus:ring focus:ring-blue-300" type="password" />
        </div>
